      ...
      <div className={styles.imageContainer}>
        ...
        <div className={styles.mainImageTextBox}>
          <div className={styles.mainImageTextSub}>
            ...
            서울 5호선 연장 기대
            <span className={styles.greyText}> 더욱 편리해질 교통 프리미엄</span> |
            품격 있는 라이프스타일
            <span className={styles.greyText}> 김포 칸타빌 에디션</span>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="김포 칸타빌 에디션 브랜드소개-image4"
                />
                <div className={styles.text1}>김포 칸타빌 에디션</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xjgpbprb"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="김포 칸타빌 에디션 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
              - 북변 새도시 중심에서 누리는 미래가치 프리미엄<br />
              - 걸포북변역 생활권과 서울 5호선 연장 기대 교통환경<br />
              - 생활 인프라와 교육 환경을 가까이 누리는 편리한 입지<br />
              - 차별화된 평면 설계와 공간 구성으로 높아지는 주거 만족도<br />
              - 품격 있는 커뮤니티와 쾌적한 주거 환경 제공
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 김포 칸타빌 에디션에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="김포 칸타빌 에디션 모바일 조감도 이미지"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="김포 칸타빌 에디션 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="김포 칸타빌 에디션 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
