...
const ComplexGuide1 = () => {
	...
	return (
		...
		<Helmet>
			...
			{/* SEO 메타 */}
			<title>김포 칸타빌 에디션 - 단지배치도</title>
			<meta
				name="description"
				content="김포 칸타빌 에디션 단지배치도를 확인하세요. 동별 위치와 주요 동선, 커뮤니티 및 조경 공간 배치를 한눈에 확인할 수 있도록 안내합니다."
			/>
			<meta
				name="keywords"
				content="김포 칸타빌 에디션, 단지배치도, 단지안내, 김포 아파트, 김포 분양, 북변동 아파트, 조경, 커뮤니티시설"
			/>
			...
			<meta property="og:title" content="김포 칸타빌 에디션 - 단지배치도" />
			<meta
				property="og:description"
				content="김포 칸타빌 에디션 단지배치도 - 동별 위치, 주요 동선, 커뮤니티 및 조경 공간 배치를 확인하세요."
			/>
			...
			<meta property="og:image:alt" content="김포 칸타빌 에디션 단지배치도 이미지" />

			{/* Twitter */}
			<meta name="twitter:card" content="summary_large_image" />
			<meta name="twitter:title" content="김포 칸타빌 에디션 - 단지배치도" />
			<meta
				name="twitter:description"
				content="김포 칸타빌 에디션 단지배치도에서 동별 위치와 동선, 커뮤니티 및 조경 배치를 확인하세요."
			/>
			...
			<script type="application/ld+json">
				...
				"@type": "WebPage",
				"name": "김포 칸타빌 에디션 - 단지배치도",
				"description": "김포 칸타빌 에디션 단지배치도를 통해 동별 위치와 주요 동선, 커뮤니티 및 조경 공간 배치를 확인하세요.",
		...
		<h1 className={styles.screenReaderOnly}>김포 칸타빌 에디션 - 단지배치도</h1>
		<p className={styles.screenReaderOnly}>
		단지배치도 페이지는 김포 칸타빌 에디션의 단지 구성도를 제공합니다.
		동별 위치, 커뮤니티 시설, 조경 및 주요 동선을 시각적으로 확인할 수 있도록 안내합니다.
		</p>

		<div className={styles.textBox}>
		<div>한눈에 보는 단지 구성과 동선</div>
		<div>김포 칸타빌 에디션 단지배치도</div>
		</div>
