...
const ComplexGuide3 = () => {
  ...
  return (
    ...
    <Helmet>
      ...
      {/* SEO 핵심 */}
      <title>김포 칸타빌 에디션 - 커뮤니티</title>
      <meta
        name="description"
        content="김포 칸타빌 에디션 커뮤니티 시설을 소개합니다. 피트니스, 독서실, 카페 등 입주민의 편리한 일상을 위한 다양한 커뮤니티 공간을 확인하세요."
      />
      <meta
        name="keywords"
        content="김포 칸타빌 에디션, 커뮤니티, 단지 커뮤니티, 피트니스, 독서실, 카페, 김포 아파트, 김포 분양"
      />
      ...
      <meta property="og:title" content="김포 칸타빌 에디션 - 커뮤니티" />
      <meta
        property="og:description"
        content="김포 칸타빌 에디션 커뮤니티 시설과 편의공간을 한눈에 확인하세요."
      />
      ...
      <meta property="og:image:alt" content="김포 칸타빌 에디션 커뮤니티" />

      {/* Twitter */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="김포 칸타빌 에디션 - 커뮤니티" />
      <meta
        name="twitter:description"
        content="김포 칸타빌 에디션 커뮤니티 시설을 확인하세요."
      />
    ...
    <p className={styles.screenReaderOnly}>
      김포 칸타빌 에디션 커뮤니티 페이지에서는 단지 내 다양한 커뮤니티 시설을 안내합니다.
