...
const ComplexGuide1 = () => {
  ...
  return (
    ...
    <Helmet>
      ...
      {/* SEO 핵심 */}
      <title>김포 칸타빌 에디션 - 호수배치도</title>
      <meta
        name="description"
        content="김포 칸타빌 에디션 호수배치도를 통해 세대별 위치와 동·호수 배치 구조를 확인하세요."
      />
      <meta
        name="keywords"
        content="김포 칸타빌 에디션, 호수배치도, 동호수배치도, 세대배치, 김포 아파트, 김포 분양, 북변동 아파트, 단지안내"
      />
      ...
      <meta property="og:title" content="김포 칸타빌 에디션 - 호수배치도" />
      <meta
        property="og:description"
        content="김포 칸타빌 에디션 호수배치도에서 세대 위치와 배치 구조를 한눈에 확인하세요."
      />
      ...
      <meta property="og:image:alt" content="김포 칸타빌 에디션 호수배치도" />

      {/* Twitter */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="김포 칸타빌 에디션 - 호수배치도" />
      <meta
        name="twitter:description"
        content="김포 칸타빌 에디션 호수배치도를 통해 세대 위치와 동·호수 배치를 확인하세요."
      />
