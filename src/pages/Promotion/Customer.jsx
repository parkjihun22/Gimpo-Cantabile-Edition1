...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/xjgpbprb", {
        method: "POST",
...
<>
      <Helmet>
        ...
        {/* Primary SEO */}
        <title>김포 칸타빌 에디션– 관심고객 등록</title>
        <meta
          name="description"
          content="김포 칸타빌 에디션관심고객 등록 페이지입니다. 분양 일정 및 주요 안내 소식을 빠르게 받아보고, 상담 요청을 남겨보세요."
        />
        <meta
          name="keywords"
          content="김포 칸타빌 에디션, 관심고객 등록, 상담 신청, 분양 일정 알림, 방문 안내"
        />
        <link rel="canonical" href="https://www.bunyang-114.com/Contact/interest" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="ko_KR" />
        <meta property="og:site_name" content="김포 칸타빌 에디션" />
        <meta property="og:title" content="김포 칸타빌 에디션– 관심고객 등록" />
        <meta
          property="og:description"
          content="분양 일정 및 주요 안내 소식을 빠르게 받아보세요. 간편한 관심고객 등록/상담 신청."
        />
        <meta property="og:url" content="https://www.bunyang-114.com/Contact/interest" />
        <meta property="og:image" content="https://www.bunyang-114.com/Main1.png" />
        <meta
          property="og:image:alt"
          content="김포 칸타빌 에디션관심고객 등록 안내 이미지"
        />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="김포 칸타빌 에디션– 관심고객 등록" />
        <meta
          name="twitter:description"
          content="분양 일정 알림과 상담 요청을 간편하게 남겨보세요."
        />
        <meta name="twitter:image" content="https://www.bunyang-114.com/Main1.png" />
        <meta name="twitter:url" content="https://www.bunyang-114.com/Contact/interest" />
        ...
        <script type="application/ld+json">
          {`{
            ...
            "@type": "ContactPage",
            "name": "김포 칸타빌 에디션– 관심고객 등록",
            "url": "https://www.bunyang-114.com/Contact/interest",
            "inLanguage": "ko-KR",
            "description": "김포 칸타빌 에디션관심고객 등록. 분양 일정 및 주요 안내 소식 알림과 상담 요청을 접수합니다.",
            "isPartOf": {
              "@type": "WebSite",
              "name": "김포 칸타빌 에디션",
            ...
            "breadcrumb": {
              ...
              "itemListElement": [{
                ...
                "position": 2,
                "name": "관심고객 등록",
                "item": "https://www.bunyang-114.com/Contact/interest"
              }]
            },
            "potentialAction": {
              "@type": "SubmitAction",
              "target": "https://www.bunyang-114.com/Contact/interest",
              "name": "관심고객 등록 제출"
            }
          }`}
        </script>
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>김포 칸타빌 에디션</h2>
